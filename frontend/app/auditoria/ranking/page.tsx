          ...
          <div className="mx-auto px-6" style={{ maxWidth: "1312px" }}>
            <div style={{ borderLeft: "4px solid var(--blue-60)", paddingLeft: "24px" }}>
              ...
              <p style={{ fontSize: "16px", lineHeight: "26px", color: "var(--text-02)", maxWidth: "620px" }}>
                Classificação baseada em critérios objetivos: taxa de execução das emendas, distribuição de recursos e transparência.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto px-6" style={{ maxWidth: "1312px" }}>
            <div style={{ width: "100%", marginBottom: "40px" }}>
              <p style={{ fontSize: "16px", lineHeight: "24px", color: "var(--text-02)", marginBottom: "16px" }}>
                O ranking classifica os agentes políticos com base em <strong>critérios objetivos</strong>, sem juízo de valor pessoal.
                A pontuação é calculada automaticamente a partir dos dados de execução das emendas e da transparência das informações disponíveis.
              </p>
