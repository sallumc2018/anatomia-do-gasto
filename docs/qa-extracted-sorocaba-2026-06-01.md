# QA extracted Sorocaba - 2026-06-01
...
- `data/extracted/sorocaba/urbes/contratos_contratos_outros_reparsed.csv`: csv, rows=47, columns=10, status=ok
- `data/extracted/sorocaba/urbes/contratos_contratos_receitas_ocr.csv`: csv, rows=91, columns=10, status=ok
- `data/extracted/sorocaba/urbes/contratos_contratos_receitas_reparsed.csv`: csv, rows=91, columns=10, status=ok
- `data/extracted/sorocaba/urbes/contratos_contratos_transporte_ocr.csv`: csv, rows=47, columns=10, status=ok
- `data/extracted/sorocaba/urbes/contratos_contratos_transporte_reparsed.csv`: csv, rows=47, columns=10, status=ok
