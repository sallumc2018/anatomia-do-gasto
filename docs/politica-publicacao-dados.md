...
Para expansao municipal e de areas, esta politica e operacionalizada por
`docs/protocolo-dados-reais-expansao.md`.
...
4. bloquear delecoes acidentais em `data/public` no gate de commit;
5. so depois avaliar se a limpeza deve valer apenas daqui para frente ou tambem para o historico.
