...
Com essa variavel, `pipelines/paths.py` resolve `data/raw` para `G:\Meu Drive\02-Profissional\03-Big-Data-Fiscal-Data\raw\<municipio>`. Nao copie PDFs grandes para `C:/Omega` nem para `data/raw` dentro do checkout em C:.
