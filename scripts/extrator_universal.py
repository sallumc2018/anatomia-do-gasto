...
def parse_args():
    ...
    parser.add_argument("input", nargs="*", help="Arquivos, pastas ou padrões de PDF. Se vazio, usa sorocaba/saude/entrada.")
    parser.add_argument("--output", "-o", default=None, help="Pasta onde os JSONs serão salvos. Padrão: sorocaba/saude/intermediario.")
...
def main():
    ...
    default_pdf_dir = base_dir.parent / "sorocaba" / "saude" / "entrada"
    output_dir = Path(args.output) if args.output else base_dir.parent / "sorocaba" / "saude" / "intermediario"
