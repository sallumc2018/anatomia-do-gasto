...
const THEO_ROUTES: TheoRoute[] = [
  {
    ...
    links: [
      { href: "/receita", label: "Abrir receita" },
      { href: "/pacto-federativo", label: "Pacto federativo" },
  ...
  },
  {
    ...
    links: [
      { href: "/pacto-federativo", label: "Abrir pacto federativo" },
      { href: "/receita", label: "Ver receita total" },
    ],
  ...
  },
  {
    ...
    links: [
      { href: "/executivo", label: "Abrir orçamento" },
  ...
  },
  {
    ...
    links: [
      { href: "/execucao", label: "Abrir execução" },
  ...
  },
  {
    ...
    links: [
      { href: "/execucao", label: "Abrir execução orçamentária" },
      { href: "/metodologia", label: "Ver metodologia" },
    ],
  ...
  },
  {
    ...
    links: [
      { href: "/saude", label: "Mínimo em saúde" },
      { href: "/educacao", label: "Mínimo em educação" },
  ...
  },
  {
    ...
    links: [
      { href: "/camara-municipal", label: "Abrir Câmara" },
      { href: "/auditoria", label: "Ver agentes" },
    ],
  ...
  },
  {
    ...
    links: [
      { href: "/saude-fiscal", label: "Abrir saúde fiscal" },
      { href: "/dados", label: "Baixar CSVs" },
    ],
  ...
  },
  {
    ...
    links: [
      { href: "/auditoria", label: "Abrir auditoria" },
      { href: "/metodologia", label: "Ver metodologia" },
    ],
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/dados", label: "Abrir datasets" },
      { href: "/auditoria", label: "Abrir auditoria" },
    ],
