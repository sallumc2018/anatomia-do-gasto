...
export const SEARCH_INDEX: SearchEntry[] = [
  {
    ...
    keywords: ["saúde", "saude", "hospital", "ubs", "sus", "asps", "atenção básica", "15%", "vigilância"],
  },
  {
    title: "Educação em Sorocaba",
    href: "/educacao",
    description: "Gasto em educação 2020–2025, FUNDEB, MDE, mínimo constitucional de 25%",
    keywords: ["educação", "educacao", "escola", "fundeb", "mde", "25%", "ensino fundamental", "educação infantil"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["transporte", "ônibus", "onibus", "obras viárias", "mobilidade", "função 26"],
  },
  {
    title: "Câmara Municipal",
    href: "/camara-municipal",
    description: "25 vereadores, subsídios, LOA da Câmara 2020–2025",
    keywords: ["câmara", "camara", "vereador", "vereadores", "subsídio", "subsidio", "legislativo", "loa", "partido"],
  },
  {
    title: "Orçamento Municipal",
    href: "/executivo",
    description: "Orçamento total de Sorocaba por função 2020–2025, R$ 5,4 bilhões em 2025",
    keywords: ["orçamento", "orcamento", "executivo", "prefeitura", "função", "funcao", "gasto total", "bilhões", "rreo"],
  },
  {
    title: "Saúde Fiscal",
    href: "/saude-fiscal",
  ...
  },
  {
    ...
    keywords: ["receita", "arrecadação", "impostos", "iss", "iptu", "itbi", "transferências", "fpm", "icms", "ipva", "fundeb", "sus federal", "rreo", "anexo 01"],
  },
  {
    title: "Pacto Federativo",
    href: "/pacto-federativo",
    description: "Como os recursos federais e estaduais chegam ao município de Sorocaba",
