...
const nextConfig: NextConfig = {
  ...
  outputFileTracingIncludes: {
    ...
    "/sao-bernardo/saude":                 ["../../data/public/sao_bernardo/saude/saida/**/*"],
    "/sao-bernardo/saude/comparativo":     ["../../data/public/sao_bernardo/saude/saida/**/*"],
    "/sao-bernardo/saude/relatorio/[ano]": ["../../data/public/sao_bernardo/saude/saida/**/*"],
    "/sao-bernardo/educacao":              ["../../data/public/sao_bernardo/educacao/saida/**/*"],
    "/sao-bernardo/educacao/comparativo":  ["../../data/public/sao_bernardo/educacao/saida/**/*"],
    "/sao-bernardo/educacao/relatorio/[ano]": ["../../data/public/sao_bernardo/educacao/saida/**/*"],
