...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: Array<{ route: string; mtime: Date; freq: "weekly" | "monthly"; priority: number }> = [
    ...
    { route: "/paulinia",                        mtime: SITE_UPDATED,      freq: "monthly", priority: 0.85 },
    ...
    { route: "/paulinia/fornecedores",           mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    { route: "/paulinia/controle-externo",       mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    ...
    { route: "/paulinia/transporte",             mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    { route: "/paulinia/saude",                  mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    { route: "/paulinia/camara",                 mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    ...
    { route: "/sao-bernardo/seguranca",          mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    { route: "/sao-bernardo/transporte",         mtime: SITE_UPDATED,      freq: "monthly", priority: 0.75 },
    ...
    { route: "/sorocaba/acesso-a-informacao",    mtime: SITE_UPDATED,      freq: "monthly", priority: 0.7 },
    ...
    { route: "/sorocaba/camara",                 mtime: SITE_UPDATED,      freq: "monthly", priority: 0.7 },
    ...
    { route: "/sorocaba/transferencias",         mtime: SITE_UPDATED,      freq: "monthly", priority: 0.7 },
    ...
    { route: "/como-citar",                      mtime: SITE_UPDATED,      freq: "monthly", priority: 0.8 },
    { route: "/metodologia",                     mtime: SITE_UPDATED,      freq: "monthly", priority: 0.7 },
    { route: "/sobre",                           mtime: SITE_UPDATED,      freq: "monthly", priority: 0.7 },
    { route: "/sobre/fundador",                  mtime: SITE_UPDATED,      freq: "monthly", priority: 0.6 },
    { route: "/voluntarios",                     mtime: SITE_UPDATED,      freq: "monthly", priority: 0.7 },
    { route: "/apoie",                           mtime: SITE_UPDATED,      freq: "monthly", priority: 0.8 },
