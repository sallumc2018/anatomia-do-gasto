...
export const metadata: Metadata = {
  title: "Saúde em São Bernardo do Campo — série histórica (SIOPS)",
  description:
    "Série histórica do gasto municipal em saúde de São Bernardo do Campo: percentual da receita de impostos aplicado em ASPS, gasto total e cumprimento do mínimo constitucional de 15% (SIOPS).",
  alternates: { canonical: `${SITE_URL}/sao-bernardo/saude/comparativo` },
}
...
export default function ComparativoSaudeSaoBernardoPage() {
        ...
        <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-14 md:py-20" style={S.container}>
            <div className="flex items-center gap-3 mb-4">
              <Link href="/sao-bernardo/saude" style={{ ...S.small, color: "var(--text-03)", textDecoration: "none" }}>Saúde</Link>
            ...
            <div style={{ borderLeft: "4px solid var(--teal-60)", paddingLeft: "24px" }}>
              <p className="uppercase font-semibold mb-3" style={S.label}>
                Saúde · São Bernardo do Campo/SP{anoMin && anoMax ? ` · ${anoMin}–${anoMax}` : ""}
              </p>
              <h1 className="font-light mb-5" style={{ fontSize: "clamp(26px, 3.5vw, 42px)", lineHeight: "1.2", color: "var(--text-01)", maxWidth: "720px" }}>
                Quanto São Bernardo do Campo aplicou em saúde a cada ano
              </h1>
          ...
          <div className="mx-auto px-6 py-14" style={S.container}>
            ...
            <div className="mt-4 p-5" style={{ backgroundColor: "var(--bg-elevated)", border: "1px solid var(--border-01)" }}>
              <p style={{ ...S.body, color: "var(--text-03)" }}>
                ...
                &ldquo;gasto por habitante&rdquo; (despesa_saude_por_hab) retornado pelo SIOPS para São
                Bernardo do Campo traz valores agregados maiores que a própria despesa total em saúde —
                logicamente incompatíveis com um valor por habitante (ex.: em 2025, o campo registra
                R$ 1,30 bi, acima dos R$ 704,9 mi de despesa total). O mesmo padrão aparece nos dados
                SIOPS de São Paulo e Paulínia. Por isso, esse campo não é exibido nesta página — divulgar
                um número que não bate com sua própria definição seria publicar estatística sem fonte
                confiável.
              </p>
            </div>
          </div>
        ...
        <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-14" style={S.container}>
            ...
            <p className="mb-8" style={{ ...S.body, color: "var(--text-03)", maxWidth: "640px" }}>
              Anos sem declaração no SIOPS para São Bernardo do Campo não estão disponíveis e não são
              exibidos como zero — são omitidos desta série.
            </p>
                    ...
                    return (
                      <tr key={row.ano} style={{ borderBottom: "1px solid var(--border-01)" }}>
                        ...
                        <td style={{ padding: "14px 0 14px 0", textAlign: "right" }}>
                          <Link href={`/sao-bernardo/saude/relatorio/${row.ano}`} style={{ fontSize: "12px", color: "var(--blue-50)", textDecoration: "none" }}>
                            Ver {row.ano} →
                          </Link>
                        </td>
                      </tr>
          ...
          <div className="mx-auto px-6 py-14" style={S.container}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <ul className="flex flex-col gap-3">
                  {[
                    "Distribuição do gasto entre atenção básica, hospitalar, vigilância sanitária e demais funções — o SIOPS de São Bernardo do Campo não detalha o gasto por função, ao contrário dos relatórios LRF de Sorocaba.",
                ...
                <p className="mt-6" style={{ ...S.small, color: "var(--text-04)" }}>
                  Essas informações não constam do SIOPS agregado de São Bernardo do Campo. Caso a
                  prefeitura publique relatórios de execução detalhados por função, este site poderá
                  incorporá-los no futuro.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="mt-2" style={S.body}>
                  ...
                  da Saúde, com base nas declarações do município de São Bernardo do Campo (Fase Previsto).
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="mt-2 flex flex-col gap-2">
                  ...
                  <Link href="/sao-bernardo/saude" style={{ fontSize: "13px", color: "var(--blue-50)", textDecoration: "none" }}>
                    Voltar para Saúde em São Bernardo do Campo →
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto px-6 py-12" style={S.container}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
              {[...rows].reverse().map((row) => (
                <Link key={row.ano} href={`/sao-bernardo/saude/relatorio/${row.ano}`}
                  className="tile-link"
