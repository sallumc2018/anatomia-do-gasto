...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.anatomiadogasto.ong.br/sao-bernardo/receita" },
}
...
export default async function SaoBernardoReceitaPage({
  searchParams,
}: {
  ...
  const insights: string[] = [
    ...
    ...(growthSerie !== null
      ...
      : []),
    `As transferências intergovernamentais representam ${depTransf.toFixed(1)}% das receitas exceto intra-orçamentárias.`,
          ...
          <div className="mx-auto px-6 py-16 md:py-24" style={S.container}>
            <div className="mobile-hero-inset" style={{ borderLeft: "4px solid var(--blue-60)", paddingLeft: "24px" }}>
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <p className="uppercase font-semibold" style={S.label}>Receita Municipal · São Bernardo do Campo/SP</p>
              ...
              <p style={{ ...S.body, maxWidth: "640px", marginBottom: "12px" }}>
                Em {anoFeatured}, São Bernardo do Campo arrecadou{" "}
        ...
        <section style={{ backgroundColor: "var(--bg-base)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-4" style={S.container}>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <AnoSelector anos={anos} selectedAno={anoFeatured} basePath="/sao-bernardo/receita" />
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12">
              <div>
                ...
                <p style={{ ...S.body, marginBottom: "16px" }}>
                  O gráfico mostra a composição da receita corrente de São Bernardo do Campo em {anoFeatured}.
                </p>
                {intra > 0 && (
                  <div className="p-4" style={{ backgroundColor: "var(--bg-elevated)", border: "1px solid var(--border-01)" }}>
                    <p style={{ ...S.caption, lineHeight: "18px" }}>
                      ...
                      {fmt(intra)} são receitas intra-orçamentárias — contribuições previdenciárias dos servidores ao RPPS.
        ...
        <section id="metodologia" style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-12" style={S.container}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                <p className="uppercase font-semibold mb-3" style={S.label}>São Bernardo do Campo</p>
                <p style={S.body}>
                  SBC é o maior município do ABC Paulista e um dos maiores centros industriais do Brasil.
                  Sede de montadoras como Scania e Mercedes-Benz, tem base tributária fortemente ligada
                  ao setor industrial, o que reflete na composição das receitas.
                </p>
              </div>
              <div>
