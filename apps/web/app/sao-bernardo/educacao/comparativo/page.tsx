...
export const metadata: Metadata = {
  title: "Educação em São Bernardo do Campo — série histórica do MDE",
  description:
    "Série histórica do Mínimo de Desenvolvimento do Ensino (MDE) em São Bernardo do Campo: percentual aplicado, limite constitucional de 25% e situação de cumprimento por ano. Fonte: SIOPE/FNDE.",
  alternates: { canonical: `${SITE_URL}/sao-bernardo/educacao/comparativo` },
}
...
const jsonLd = [
  datasetSchema({
    name: "Mínimo de Desenvolvimento do Ensino (MDE) — São Bernardo do Campo",
    description:
      "Série histórica do indicador constitucional de MDE do Município de São Bernardo do Campo: percentual aplicado, limite constitucional (25%) e situação de cumprimento, por ano. Fonte: SIOPE/FNDE. IBGE 3548708.",
    url: `${SITE_URL}/sao-bernardo/educacao/comparativo`,
    temporalCoverage: `${ANOS[0]}/${ANOS[ANOS.length - 1]}`,
    spatialCoverage: "São Bernardo do Campo, SP, Brasil (IBGE 3548708)",
    keywords: ["educação", "São Bernardo do Campo", "SIOPE", "MDE", "FUNDEB"],
...
export default function ComparativoEducacaoSaoBernardoPage() {
        ...
        <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-14 md:py-20" style={S.container}>
            <div className="flex items-center gap-3 mb-4">
              <Link href="/sao-bernardo/educacao" style={{ ...S.small, color: "var(--text-03)", textDecoration: "none" }}>Educação</Link>
            ...
            <div style={{ borderLeft: "4px solid var(--green-60)", paddingLeft: "24px" }}>
              <p className="uppercase font-semibold mb-3" style={S.label}>
                Educação · São Bernardo do Campo/SP · {ANOS[0]}–{ANOS[ANOS.length - 1]}
              </p>
              <h1 className="font-light mb-5" style={{ fontSize: "clamp(26px, 3.5vw, 42px)", lineHeight: "1.2", color: "var(--text-01)", maxWidth: "720px" }}>
                O cumprimento do mínimo constitucional de educação em São Bernardo do Campo, ano a ano
              </h1>
              <p style={{ ...S.body, fontSize: "15px", lineHeight: "24px", maxWidth: "640px" }}>
                ...
                Ensino (MDE) de São Bernardo do Campo: o percentual de receitas de impostos aplicado em
                educação e a comparação com o mínimo constitucional de 25%. Os dados vêm do Sistema de
                Informações sobre Orçamentos Públicos em Educação (SIOPE/FNDE).
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                <p style={{ ...S.body, marginBottom: "16px" }}>
                  ...
                  O indicador é apurado e publicado pelo próprio ente ao Sistema de Informações sobre
              ...
              <div className="p-6" style={{ backgroundColor: "var(--bg-elevated)", border: "1px solid var(--border-01)" }}>
                <p className="font-semibold mb-4" style={S.h3}>Cobertura de dados</p>
                <p style={S.body}>
                  Para São Bernardo do Campo, o indicador de MDE (SIOPE) está publicado pela fonte
                  oficial em{" "}
                  <strong style={{ color: "var(--text-01)" }}>todos</strong> os {ANOS.length} anos
                  cobertos por este site ({ANOS[0]}–{ANOS[ANOS.length - 1]}), com cumprimento do mínimo
                  constitucional em todos eles.
                </p>
              </div>
            </div>
          </div>
        ...
        <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-14" style={S.container}>
            ...
            <p className="mb-8" style={{ ...S.body, color: "var(--text-03)", maxWidth: "640px" }}>
              Indicador anual do SIOPE. Anos sem publicação do indicador aparecem
                      ...
                      <tr key={row.ano} style={{ borderBottom: "1px solid var(--border-01)" }}>
                        ...
                        <td style={{ padding: "14px 0 14px 16px", textAlign: "right", whiteSpace: "nowrap" }}>
                          ...
                          {!semDado && (
                            <>
                              {" "}
                              <Link href={`/sao-bernardo/educacao/relatorio/${row.ano}`} style={{ fontSize: "12px", color: "var(--blue-50)", textDecoration: "none" }}>
                                Ver {row.ano} →
                              </Link>
                            </>
                          )}
            ...
            {anosSemDado.length > 0 && (
              <div className="mt-6 p-4" style={{ backgroundColor: "var(--bg-base)", border: "1px solid var(--border-01)" }}>
                <p style={{ ...S.small, color: "var(--text-03)" }}>
                  ...
                  no SIOPE, não uma falha de coleta do Anatomia do Gasto.
                </p>
              </div>
            )}
          </div>
        ...
        <section style={{ backgroundColor: "var(--bg-base)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-12" style={S.container}>
            ...
            <p style={{ ...S.body, maxWidth: "640px" }}>
              ...
              (PDDE, PNAE, PNATE, FUNDEB) para São Bernardo do Campo: não existe hoje uma fonte pública
          ...
          <div className="mx-auto px-6 py-12" style={S.container}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <p className="mt-2" style={S.body}>
                  Um pipeline consulta a fonte pública do SIOPE, extrai o indicador de MDE por exercício
                  e salva em arquivos CSV. Quando o SIOPE não retorna dado para um ano, o arquivo
              ...
              <div>
                ...
                <div className="mt-2 flex flex-col gap-2">
                  ...
                  <Link href="/sao-bernardo/educacao" style={{ fontSize: "13px", color: "var(--blue-50)", textDecoration: "none" }}>
            ...
            <div className="mx-auto px-6 py-12" style={S.container}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                {[...anosComDado].reverse().map((row) => (
                  <Link key={row.ano} href={`/sao-bernardo/educacao/relatorio/${row.ano}`}
                    className="tile-link"
