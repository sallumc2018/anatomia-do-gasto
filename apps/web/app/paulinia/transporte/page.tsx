...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.anatomiadogasto.ong.br/paulinia/transporte" },
}
      ...
      <main id="conteudo" className="flex-1">
          ...
          <div className="mx-auto px-6 py-16 md:py-24" style={S.container}>
            <div style={{ borderLeft: "4px solid var(--cyan-60)", paddingLeft: "24px" }}>
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <p className="uppercase font-semibold" style={S.label}>Transporte · Paulínia/SP</p>
        ...
        {totalAnualData.length > 0 && (
          <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
            <div className="mx-auto px-6 py-12" style={S.container}>
              ...
              <p className="mb-6" style={S.caption}>Função 26 — Transporte · DCA Anexo I-E · Paulínia/SP</p>
        ...
        <section style={{ backgroundColor: "var(--bg-base)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-12" style={S.container}>
            ...
            <p className="mt-4" style={S.caption}>
              Fonte: SICONFI/Tesouro Nacional — RREO Anexo 02 (6º bimestre) e DCA Anexo I-E. IBGE 3536505 = Paulínia/SP.
            </p>
          </div>
        </section>
