...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.anatomiadogasto.ong.br/paulinia/saude-fiscal" },
}
...
export default function PauliniaSaudeFiscalPage() {
  ...
  const pessoalInsights: string[] = [
    ...(pessoalAtual ? [
      `Em ${anoAtual}, Paulínia gastou ${pessoalAtual.dtp_pct_rcl.toFixed(2)}% da RCL ajustada com pessoal — o limite legal para o Executivo é 54% (LRF art. 20). A margem disponível é de ${(pessoalAtual.limite_maximo_pct - pessoalAtual.dtp_pct_rcl).toFixed(2)} pontos percentuais.`,
      `Do total, ${fmt(pessoalAtual.pessoal_ativo)} foram com pessoal ativo e ${fmt(pessoalAtual.pessoal_inativo)} com inativos e pensionistas (Paulínia Previ/RPPS).`,
    ] : []),
  ...
  const dividaInsights: string[] = [
    ...(dividaAtual ? [
      `A dívida consolidada bruta de Paulínia em ${anoAtual} era de ${fmt(dividaAtual.dc_bruta)} (${dividaAtual.dc_pct_rcl.toFixed(1)}% da base ajustada informada no RGF). O limite fixado pela Resolução do Senado Federal 40/2001 é de 120%.`,
      `A dívida consolidada líquida (DCL) foi de ${fmt(dividaAtual.dcl)} (${dividaAtual.dcl_pct_rcl.toFixed(2)}% da base ajustada). Paulínia historicamente mantém caixa elevado em função das receitas de royalties.`,
    ] : []),
  ]
          ...
          <div className="mx-auto px-6 py-16 md:py-24" style={S.container}>
            <div className="mobile-hero-inset" style={{ borderLeft: "4px solid var(--blue-60)", paddingLeft: "24px" }}>
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <p className="uppercase font-semibold" style={S.label}>Saúde Fiscal · Paulínia/SP</p>
              ...
              <p style={{ ...S.body, maxWidth: "640px", marginBottom: "12px" }}>
                ...
                e endividamento dos municípios. Em {anoAtual}, Paulínia gastou{" "}
                ...
                {pessoalAtual && (
                  <div className="mt-4 p-4" style={{ backgroundColor: "var(--bg-elevated)", border: "1px solid var(--border-01)" }}>
                    <p style={{ ...S.caption, lineHeight: "18px" }}>
                      ...
                      e {fmt(pessoalAtual.pessoal_inativo)} com inativos e pensionistas do RPPS (Paulínia Previ).
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12 items-start">
              <div>
                ...
                <p style={{ ...S.body, marginBottom: "16px" }}>
                  ...
                  A DCL desconta as disponibilidades de caixa — Paulínia mantém caixa expressivo.
                </p>
                <div style={S.borderTop}>
