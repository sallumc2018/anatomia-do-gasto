...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.anatomiadogasto.ong.br/paulinia/seguranca" },
}
...
export default function PauliniaSegurancaPage() {
  ...
  const insights: string[] = [
    ...(atual ? [
      `Em ${anoAtual}, Paulínia destinou ${fmt(atual.liquidado)} à segurança pública — ${pctMunicipal.toFixed(2)}% do orçamento municipal total.`,
      ...
      <main id="conteudo" className="flex-1">
          ...
          <div className="mx-auto px-6 py-16 md:py-24" style={S.container}>
            <div className="mobile-hero-inset" style={{ borderLeft: "4px solid var(--purple-60)", paddingLeft: "24px" }}>
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <p className="uppercase font-semibold" style={S.label}>Segurança Pública · Paulínia/SP</p>
              ...
              <div className="p-4 mt-4" style={{ backgroundColor: "var(--bg-base)", border: "1px solid var(--border-01)", maxWidth: "640px" }}>
                <p style={{ ...S.caption, lineHeight: "18px" }}>
                  ...
                  Para Paulínia, o detalhamento por subfunção (Policiamento, Defesa Civil, Informação e Inteligência)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p style={S.body}>
                  ...
                  6º bimestre de cada exercício. IBGE 3536505 = Paulínia/SP.
                </p>
              </div>
            </div>
          </div>
        ...
        <section style={{ backgroundColor: "var(--bg-base)" }}>
          <div className="mx-auto px-6 py-10 flex flex-wrap gap-4" style={S.container}>
            ...
            <Link href="/paulinia/transporte" className="nav-link">Transporte</Link>
