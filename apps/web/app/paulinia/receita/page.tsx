...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.anatomiadogasto.ong.br/paulinia/receita" },
}
...
export default async function PauliniaReceitaPage({
  searchParams,
}: {
  ...
  const insights: string[] = [
    ...
    ...(growthSerie !== null
      ...
      : []),
    `As transferências intergovernamentais representam ${depTransf.toFixed(1)}% das receitas exceto intra-orçamentárias — Paulínia é muito dependente da cota-parte do ICMS (royalties do petróleo) repassada pelo Estado de SP.`,
          ...
          <div className="mx-auto px-6 py-16 md:py-24" style={S.container}>
            <div className="mobile-hero-inset" style={{ borderLeft: "4px solid var(--blue-60)", paddingLeft: "24px" }}>
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <p className="uppercase font-semibold" style={S.label}>Receita Municipal · Paulínia/SP</p>
              ...
              <p style={{ ...S.body, maxWidth: "640px", marginBottom: "12px" }}>
                Em {anoFeatured}, Paulínia arrecadou{" "}
              ...
              <p style={{ ...S.body, maxWidth: "640px", color: "var(--text-03)", marginBottom: "12px" }}>
                Paulínia é um caso atípico no Brasil: a cidade sedia refinarias da Petrobras e recebe
                volumes expressivos de ICMS sobre a produção de combustíveis e royalties indiretos,
                tornando-a uma das maiores arrecadadoras per capita do Estado de SP.
              </p>
        ...
        <section style={{ backgroundColor: "var(--bg-base)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-4" style={S.container}>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <AnoSelector anos={anos} selectedAno={anoFeatured} basePath="/paulinia/receita" />
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12">
              <div>
                ...
                <p style={{ ...S.body, marginBottom: "16px" }}>
                  O gráfico mostra a composição da receita corrente de Paulínia em {anoFeatured}.
                  As transferências do Estado de SP são dominantes — refletem a cota-parte do ICMS
                  sobre combustíveis produzidos na cidade (refinaria Replan/Petrobras).
                </p>
                <p style={{ ...S.body, color: "var(--text-03)", marginBottom: "16px" }}>
                  A receita patrimonial expressiva reflete os rendimentos das aplicações financeiras
                  do município, possibilitadas pela alta disponibilidade de caixa.
                </p>
                <div className="p-4" style={{ backgroundColor: "var(--bg-elevated)", border: "1px solid var(--border-01)" }}>
                  <p style={{ ...S.caption, lineHeight: "18px" }}>
                    ...
                    ao RPPS (Paulínia Previ). São computadas à parte por representar circulação interna.
                  </p>
                </div>
              </div>
        ...
        <section id="metodologia" style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-12" style={S.container}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                <p className="uppercase font-semibold mb-3" style={S.label}>Caso Paulínia — royalties</p>
                <p style={S.body}>
                  Paulínia recebe uma das maiores cotas per capita de ICMS combustíveis do Estado de SP.
                  A refinaria Replan da Petrobras é a maior do país em capacidade e gera enorme base tributária,
                  fazendo de Paulínia um outlier em receita por habitante.
                </p>
              </div>
              <div>
