...
export const metadata: Metadata = {
  ...
  description:
    "Série histórica do gasto municipal em saúde de Paulínia: percentual da receita de impostos aplicado em ASPS, gasto total, gasto per capita e cumprimento do mínimo constitucional de 15% (SIOPS).",
          ...
          <div className="mx-auto px-6 py-14" style={S.container}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0" style={S.borderTop}>
              {[
                ...
                {
                  num: "03",
                  termo: "Gasto per capita",
                  def: "Gasto total em saúde dividido pela população do município — indicador de esforço de gasto por habitante, comparável entre anos e municípios.",
                },
                {
                  num: "04",
                  termo: "Situação",
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "13px" }}>
                <thead>
                  <tr style={{ borderBottom: "2px solid var(--border-01)" }}>
                    {["Ano", "% ASPS", "Variação", "Gasto total", "Per capita", "Situação", "Relatório"].map((h) => (
                      <th key={h} style={{
                  ...
                  {rows.map((row, i) => {
                    ...
                    return (
                      <tr key={row.ano} style={{ borderBottom: "1px solid var(--border-01)" }}>
                        ...
                        <td style={{ padding: "14px 16px 14px 0", textAlign: "right", fontFamily: "var(--font-ibm-plex-mono)", color: "var(--text-02)", whiteSpace: "nowrap" }}>
                          {fmt(row.perCapita)}
                        </td>
              ...
              <div>
                ...
                <ul className="flex flex-col gap-3">
                  {[
                    ...
                    "O gasto em saúde por habitante (per capita).",
