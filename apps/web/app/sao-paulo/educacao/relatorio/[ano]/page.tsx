...
export async function generateMetadata({ params }: { params: Promise<{ ano: string }> }): Promise<Metadata> {
  ...
  return {
    title: `MDE educação — ${ano} | São Paulo`,
    description: `Indicador de Manutenção e Desenvolvimento do Ensino (MDE) de São Paulo em ${ano}: percentual aplicado, limite constitucional e situação de cumprimento. Fonte: SICONFI/Tesouro Nacional — RREO Anexo 14.`,
    alternates: { canonical: `${SITE_URL}/sao-paulo/educacao/relatorio/${ano}` },
  }
}

export default async function RelatorioEducacaoSaoPauloPage({ params }: PageProps) {
  const { ano } = await params
  ...
  const jsonLd = [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "São Paulo", item: `${SITE_URL}/sao-paulo` },
        { "@type": "ListItem", position: 3, name: "Educação", item: `${SITE_URL}/sao-paulo/educacao` },
        { "@type": "ListItem", position: 4, name: "Série histórica", item: `${SITE_URL}/sao-paulo/educacao/comparativo` },
    ...
    breadcrumbSchema([
      ...
      { name: "Série histórica", url: `${SITE_URL}/sao-paulo/educacao/comparativo` },
      { name: String(year) },
    ]),
  ]
      ...
      <main id="conteudo" className="flex-1">
        ...
        <div style={{ backgroundColor: "var(--bg-base)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-3 flex items-center gap-2" style={{ ...S.container, flexWrap: "wrap" }}>
            ...
            <Link href="/sao-paulo/educacao" className="nav-link" style={{ fontSize: "12px" }}>Educação</Link>
            <span style={{ fontSize: "12px", color: "var(--text-04)" }}>/</span>
            <Link href="/sao-paulo/educacao/comparativo" className="nav-link" style={{ fontSize: "12px" }}>Série histórica</Link>
            <span style={{ fontSize: "12px", color: "var(--text-04)" }}>/</span>
        ...
        <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-10" style={S.container}>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              <div>
                <p className="uppercase font-semibold mb-3" style={S.label}>São Paulo / SP · Educação · MDE</p>
              ...
              <div className="mobile-scroll flex items-center gap-3">
                {anosComDado.map((r) => (
                  <Link key={r.ano} href={`/sao-paulo/educacao/relatorio/${r.ano}`} style={{
                    fontSize: "13px",
                ...
                <a
                  href={`/api/dados/sao_paulo/educacao/saida/siope_sao_paulo_${year}.csv`}
                  download
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="p-6" style={{ backgroundColor: "var(--bg-base)", border: "1px solid var(--border-01)" }}>
                ...
                <p style={S.body}>
                  ...
                  São Paulo, um detalhamento por função (ensino fundamental, educação infantil etc.)
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="mt-2 flex flex-col gap-2">
                  ...
                  <Link href="/sao-paulo/educacao/comparativo" style={{ fontSize: "13px", color: "var(--blue-50)", textDecoration: "none" }}>
