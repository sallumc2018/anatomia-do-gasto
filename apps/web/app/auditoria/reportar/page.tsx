...
const CHECKLIST = [
  "Página ou arquivo onde você encontrou a divergência.",
  "Valor, texto ou link que parece incorreto ou incompleto.",
  "Fonte oficial que permite conferir a informação.",
  "Data de acesso da fonte e período a que o dado se refere.",
  "Descrição factual do problema, sem acusação ou inferência de intenção.",
]

const FLUXO = [
  ["Recebimento", "A mensagem entra como relato a verificar, não como fato confirmado."],
  ["Triagem", "A equipe compara o relato com a fonte oficial e com os manifests públicos."],
  ["Correção", "Se houver erro confirmado no projeto, a correção fica registrada em commit, issue ou nota pública."],
  ["Limite", "Se a fonte oficial for ambígua, a página passa a declarar a limitação em vez de preencher lacuna por inferência."],
]
