      ...
      <main id="conteudo" className="flex-1">
          ...
          <div className="mx-auto px-6 py-16 md:py-24" style={S.container}>
            <div className="mobile-hero-inset" style={{ borderLeft: "4px solid var(--blue-60)", paddingLeft: "24px" }}>
              ...
              <p style={{ ...S.body, maxWidth: "640px", color: "var(--text-03)", marginBottom: "20px" }}>
                ...
                municipal por função, incluindo Prefeitura, autarquias e Câmara Municipal. Os valores
                incluem tanto dotação exceto intra-orçamentária quanto contribuições previdenciárias
                intra-orçamentárias. Dados do SICONFI (Sistema de Informações Contábeis e Fiscais do
                Setor Público Brasileiro), mantido pelo Tesouro Nacional.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0" style={S.borderTop}>
              <div className="py-8 md:pr-12" style={S.borderBottom}>
                ...
                <div className="flex flex-wrap gap-4" style={{ fontSize: "13px" }}>
                  <Link href="/sorocaba/receita" style={{ color: "var(--blue-40)", textDecoration: "none" }}>→ Receita municipal</Link>
                  <Link href="/sorocaba/saude-fiscal" style={{ color: "var(--blue-40)", textDecoration: "none" }}>→ Saúde fiscal (LRF)</Link>
                  <Link href="/sorocaba/camara-municipal" style={{ color: "var(--blue-40)", textDecoration: "none" }}>→ Câmara Municipal</Link>
                </div>
              </div>
        ...
        <section style={{ backgroundColor: "var(--bg-base)" }}>
          <div className="mx-auto px-6 py-10 flex flex-wrap gap-4" style={S.container}>
            ...
            <Link href="/sorocaba/saude" className="nav-link">Saúde</Link>
            <Link href="/sorocaba/educacao" className="nav-link">Educação</Link>
