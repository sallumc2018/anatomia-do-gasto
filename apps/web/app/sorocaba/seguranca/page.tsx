...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.anatomiadogasto.ong.br/sorocaba/seguranca" },
  openGraph: {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {years.map((year) => {
                ...
                return (
                  <TrackedReportLink
                    key={year}
                    href={`/sorocaba/seguranca/relatorio/${year}`}
                    area="seguranca"
                    year={year}
                    className="tile-link"
        ...
        <section id="graficos" style={{ backgroundColor: "var(--bg-base)", ...S.borderTop, ...S.borderBottom }}>
          <div className="mx-auto px-6 py-16" style={S.container}>
            ...
            <div className="mt-10 flex items-center justify-between" style={{ borderTop: "1px solid var(--border-01)", paddingTop: "24px" }}>
              ...
              <Link href="/sorocaba/seguranca/comparativo"
