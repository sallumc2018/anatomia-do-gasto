...
export async function generateMetadata({ params }: { params: Promise<{ ano: string }> }): Promise<Metadata> {
  ...
  return {
    title: `Despesas em segurança pública — ${ano} | Sorocaba`,
    description: `Execução orçamentária em segurança pública de Sorocaba em ${ano}: dotação atualizada, empenhada, liquidada e paga. Fonte: Relatórios publicados pela Prefeitura de Sorocaba/SP.`,
    alternates: { canonical: `https://www.anatomiadogasto.ong.br/sorocaba/seguranca/relatorio/${ano}` },
  }
}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Segurança Pública", item: "https://www.anatomiadogasto.ong.br/sorocaba/seguranca" },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        description: `Execução orçamentária em segurança pública de Sorocaba em ${year}: dotação atualizada, empenhada, liquidada e paga por subfunção. Fonte: Relatórios publicados pela Prefeitura de Sorocaba/SP.`,
        url: `https://www.anatomiadogasto.ong.br/sorocaba/seguranca/relatorio/${year}`,
      ...
      <main id="conteudo" className="flex-1">
        ...
        <div style={{ backgroundColor: "var(--bg-base)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-3 flex items-center gap-2" style={{ ...S.container, flexWrap: "wrap" }}>
            ...
            <Link href="/sorocaba/seguranca" className="nav-link" style={{ fontSize: "12px" }}>Segurança</Link>
            <span style={{ fontSize: "12px", color: "var(--text-04)" }}>/</span>
            <Link href="/sorocaba/seguranca/comparativo" className="nav-link" style={{ fontSize: "12px" }}>Série histórica</Link>
            <span style={{ fontSize: "12px", color: "var(--text-04)" }}>/</span>
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <div className="mobile-scroll flex items-center gap-3">
                {availableYears.map((y) => (
                  <Link key={y} href={`/sorocaba/seguranca/relatorio/${y}`} style={{
                    fontSize: "13px",
                ...
                <a
                  href={`/api/dados/sorocaba/seguranca/saida/despesas_seguranca_sorocaba_${year}.csv`}
                  download
