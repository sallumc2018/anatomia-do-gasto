        ...
        <section style={{ backgroundColor: "var(--bg-elevated)", ...S.borderBottom }}>
          <div className="mx-auto px-6 py-14 md:py-20" style={S.container}>
            <div className="flex items-center gap-3 mb-4">
              <Link href="/sorocaba/saude" style={{ ...S.small, color: "var(--text-03)", textDecoration: "none" }}>Saúde</Link>
                    ...
                    return (
                      <tr key={row.year} style={{ borderBottom: "1px solid var(--border-01)" }}>
                        ...
                        <td style={{ padding: "14px 0 14px 0", textAlign: "right" }}>
                          <Link href={`/sorocaba/saude/relatorio/${row.year}`} style={{ fontSize: "12px", color: "var(--blue-50)", textDecoration: "none" }}>
                            Ver {row.year} →
                          </Link>
                        </td>
                      </tr>
              ...
              {rows.map((row) => (
                <div key={row.year} className="py-10" style={S.borderBottom}>
                  <div className="flex items-baseline gap-4 mb-6">
                    ...
                    <Link href={`/sorocaba/saude/relatorio/${row.year}`} style={{ fontSize: "12px", color: "var(--blue-50)", textDecoration: "none", marginLeft: "auto" }}>
                      Relatório completo →
                    </Link>
                  </div>
          ...
          <div className="mx-auto px-6 py-12" style={S.container}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
              {[...years].reverse().map((year) => (
                <Link key={year} href={`/sorocaba/saude/relatorio/${year}`}
                  className="tile-link"
