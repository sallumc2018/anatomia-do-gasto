...
const LACUNAS: Lacuna[] = [
  ...
  },
  {
    ...
    proximo_passo: "Retomar coleta por janelas menores, com checkpoint e validação de cobertura antes de publicar.",
    observacao: "API oficial confirmada. Extração interna parcial gerou atas, mas endpoints tiveram timeout/intermitência e compras/contratos ainda não têm snapshot confiável para publicação.",
  },
  {
    area: "Contratos e licitações",
  ...
  },
  {
    ...
    proximo_passo: "Validar semanticamente os CSVs extraídos e cruzar emendas com empenho, liquidação e pagamento antes de publicar.",
    observacao: "API oficial coletada internamente em 2026-05-20: 3.627 emendas, 3.741 dotações e 10.130 eventos. Ainda não publicado.",
  },
  {
    area: "Câmara Municipal",
  ...
  },
  {
    ...
    proximo_passo: "Normalizar receitas, despesas, licitações, contratos, obras e pessoal do TDAPortal antes de publicar.",
    observacao: "TDAPortal respondeu em amostra oficial de 2025 para dados abertos, receitas, despesas, licitações, contratos, obras e pessoal. Os CSVs atuais são recortes técnicos internos, ainda sem validação semântica.",
  },
  {
    area: "FUNSERV",
    ...
    proximo_passo: "Baixar/validar a malha documental completa e transformar inventário em datasets normalizados.",
    observacao: "Inventário oficial avançou em 2026-05-20 para avaliação atuarial, balanços, APR, rentabilidade, receitas/despesas e governança. Detalhe do fundo ainda não foi publicado.",
  },
  {
  ...
  },
  {
    ...
    proximo_passo: "Automatizar consulta processual legada com sessão/navegador e extrair textos completos dos PDFs quando necessário.",
    observacao: "Fontes oficiais do TCE/AUDESP foram inventariadas. Há alertas e contas anuais em extração interna, mas pesquisa processual completa ainda depende de automação do portal legado.",
  },
  {
    area: "SICONFI",
