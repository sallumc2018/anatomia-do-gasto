...
from paths import CFG, MUNICIPIO, EXTRACTED_DIR

if not CFG.get("cnpj_prefeitura"):
    raise SystemExit(
        f"MUNICIPIO={MUNICIPIO!r} nao tem 'cnpj_prefeitura' configurado em paths.py."
    )

CNPJ = CFG["cnpj_prefeitura"]
    ...
    with sync_playwright() as p:
        ...
        for tipo in tipos_selecionados:
            ...
            for ano in anos:
                ...
                nome = f"pncp_{MUNICIPIO}_{label}_{ano}.csv"
