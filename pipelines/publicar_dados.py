...
# extracted->public: fontes oficiais (SICONFI/Tesouro, Fazenda-SP, FNS) cuja
# integridade e garantida pela API federal/estadual. Paulinia (2026-06-01):
# receita, executivo, fiscal, transferencias_federais, transferencias_estaduais, fns
# entram aqui pela mesma razao que seguranca/transporte (ver QA TCE x SICONFI).
AREAS_EXTRACTED = {
    "seguranca", "transporte",
    "receita", "executivo", "fiscal",
    "transferencias_federais", "transferencias_estaduais", "fns",
}
