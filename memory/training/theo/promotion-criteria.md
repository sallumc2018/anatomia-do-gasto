...
- At least 5 candidate keywords have been human-promoted (i.e., merged into `lib/theo/routes.ts`).
...
At C2, Théo MUST NOT:
- modify `lib/theo/routes.ts` (always human-promoted)
...
- modifying `apps/web/lib/theo/routes.ts` autonomously
