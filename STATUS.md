...
- Crontab 2026-07-12: `coleta_noturna.sh` ganhou `timeout 21600` (6h), igualando ao `sprint2_24x7_worker.py` que já tinha. Ambos já iniciavam `0 3 * * *` UTC (00:00 BRT) em paralelo; faltava o teto de horário no `coleta_noturna.sh`, que rodava sem limite (motivo de ter passado de 06h33 na noite anterior). Agora os dois começam 00:00 BRT e são forçados a parar às 06:00 BRT em ponto, coletando o que for possível na janela — até haver servidor 24/7 dedicado.
## Ativo — 2026-07-09
