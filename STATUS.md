...
- P1 Contratos/testes ⬜ Codex: testes p/ transferencias_federais, emendas_federais, fns
- P1 Frontend ✅ `fbf0b2a`: canonicals, títulos duplos, Recharts, gramática PT-BR
- P2 Confiabilidade ⬜ Codex+Claude: allowlist API, Ruff keys, hotspot refactor
