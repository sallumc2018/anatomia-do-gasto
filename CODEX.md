...
- Ao alterar registry ou automacao de agentes, rodar `python -m compileall -q tools/agents`, `python tools/agents/validate-agent-contracts.py`, `python tools/agents/check-scope-gates.py` e `python tools/agents/plan-route.py "completar dados faltantes sorocaba"`.
